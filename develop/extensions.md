...
This document present different extensions and profile that i am using for my development.
some of them works both on cursor and vscode, and some are available for vs code only.
...
- [Export Extensions](#export-extensions)
  - [GIT/SCM](#gitscm)
  - [IDE Tools](#ide-tools)
  - [Usability/Tools](#usabilitytools)
  - [Python](#python)
  - [Node/Typescript](#nodetypescript)
  - [dotnet/Unity](#dotnetunity)
